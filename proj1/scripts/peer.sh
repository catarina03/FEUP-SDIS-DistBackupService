...
# Examples (from de root of the build tree):
# ./../scripts/peer.sh 1.0 1 Peer1 232.0.0.0 1111 232.0.0.1 2222 232.0.0.2 3333
# ./../scripts/peer.sh 1.0 2 Peer2 232.0.0.0 1111 232.0.0.1 2222 232.0.0.2 3333
# ./../scripts/peer.sh 1.0 3 Peer3 232.0.0.0 1111 232.0.0.1 2222 232.0.0.2 3333
# ./../scripts/peer.sh 1.0 4 Peer4 232.0.0.0 1111 232.0.0.1 2222 232.0.0.2 3333
